...
export NEUTTS_LLAMA_THREADS="${NEUTTS_LLAMA_THREADS:-2}"
export NEUTTS_LLAMA_THREADS_BATCH="${NEUTTS_LLAMA_THREADS_BATCH:-2}"
export NEUTTS_LLAMA_FLASH_ATTN="${NEUTTS_LLAMA_FLASH_ATTN:-0}"
